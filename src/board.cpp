...
Board::Board() { std::fill(_board, _board + kNumberOfCells, ' '); }
...
bool Board::IsEmpty() const {
  return std::find_if(_board, _board + kNumberOfCells, [](char c)->bool {
           return c != ' ';
         }) == _board + kNumberOfCells;
}

bool Board::IsFull() const {
  return std::find(_board, _board + kNumberOfCells, ' ') ==
         _board + kNumberOfCells;
}
...
size_t Board::GetFirstOpenCell() const {
  ...
  return std::find(_board, _board + kNumberOfCells, ' ') - _board;
}
