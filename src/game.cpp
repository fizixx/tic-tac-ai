...
Game::Game() : _currentPlayer(PLAYER_UNKNOWN), _player1(0), _player2(0) {}

Game::~Game() {}

void Game::SetPlayer1(Player* player) { _player1 = player; }

void Game::SetPlayer2(Player* player) { _player2 = player; }
